...
export const DUAL_SERVICE = 'https://api.verus.services'
export const DUAL_SERVICE_ID = 'VRSC'
export const LOCAL_DEV_DUAL_SIGNING_SERVER = 'http://127.0.0.1:25000'
export const LOCAL_DEV_DUAL_LOGIN_SERVER = 'http://127.0.0.1:21001'
export const DEFAULT_SERVICE = DUAL_SERVICE
